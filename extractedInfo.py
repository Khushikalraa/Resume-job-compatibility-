...
from cleaningResume import cleaned_text
...
def extract_skills(text):
    ...
    [{"LOWER": "software"}, {"LOWER": "architecture"}], [{"LOWER": "mobile"}, {"LOWER": "development"}]]
...
print("Extracted Experience:", extracted_experience)
